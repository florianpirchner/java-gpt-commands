...
If you are not familiar with GPT, read the subsection "[magic about prompting"](#the_magic_about_prompting) in this document first. (Link not working right now. Just scroll down.)
