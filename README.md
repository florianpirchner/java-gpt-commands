...
If you are not familiar with GPT, read the subsections "[The magic about prompting"](#the_magic_about_prompting) and ["Putting GPT-4 into a cage"](#putting_gpt-4_into_a_cage) in this document first. (Links do not work right now. Just scroll down to "The magic about prompting")
